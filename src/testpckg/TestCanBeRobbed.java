...
public class TestCanBeRobbed 
{
	...
	private void loadMyMap(Map<HexLocation, Hex> hexes)
	{
		...
		hexes.put(hexLoc2, new Hex(hexLoc2, HexType.WATER, new NumberToken(0), new Port(new HexLocation(3, 3), EdgeDirection.North,3,PortType.BRICK)));
		hexes.put(hexLoc3, new Hex(hexLoc3, HexType.WATER, new NumberToken(0), null));
		hexes.put(hexLoc4, new Hex(hexLoc4, HexType.WATER, new NumberToken(0), new Port(new HexLocation(3, 3), EdgeDirection.North,3,PortType.BRICK)));
		...
		hexes.put(hexLoc9, new Hex(hexLoc9, HexType.WATER, new NumberToken(0), new Port(new HexLocation(3, 3), EdgeDirection.North,3,PortType.BRICK)));
		...
		hexes.put(hexLoc15, new Hex(hexLoc15, HexType.WATER, new NumberToken(0), new Port(new HexLocation(3, 3), EdgeDirection.North,3,PortType.BRICK)));

		hexes.put(hexLoc16, new Hex(hexLoc16, HexType.WATER,new NumberToken(0), new Port(new HexLocation(3, 3), EdgeDirection.North,3,PortType.BRICK)));
		...
		hexes.put(hexLoc23, new Hex(hexLoc23, HexType.WATER, new NumberToken(0), new Port(new HexLocation(3, 3), EdgeDirection.North,3,PortType.BRICK)));
		...
		hexes.put(hexLoc33, new Hex(hexLoc33, HexType.WATER,new NumberToken(0), new Port(new HexLocation(3, 3), EdgeDirection.North,3,PortType.BRICK)));

		hexes.put(hexLoc34, new Hex(hexLoc34, HexType.WATER, new NumberToken(0), null));
		hexes.put(hexLoc35, new Hex(hexLoc35, HexType.WATER, new NumberToken(0), new Port(new HexLocation(3, 3), EdgeDirection.North,3,PortType.BRICK)));
		hexes.put(hexLoc36, new Hex(hexLoc36, HexType.WATER, new NumberToken(0), null));
		hexes.put(hexLoc37, new Hex(hexLoc37, HexType.WATER, new NumberToken(0), new Port(new HexLocation(3, 3), EdgeDirection.North,3,PortType.BRICK)));
	}
