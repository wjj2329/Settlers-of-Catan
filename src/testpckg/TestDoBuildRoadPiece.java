...
public class TestDoBuildRoadPiece
{
    ...
    public void setUp() throws Exception
    {
        ...
        CatanMap myMap = ModelFacade.facadeCurrentGame.currentgame.getMymap();
    ...
    private void initialize2() throws Exception
    {
        ...
        hex2 = ModelFacade.facadeCurrentGame.currentgame.getMymap().getHexes().get(loc2);
    ...
    public void testFail_BothHexesAreWater() throws Exception
    {
        ...
        Hex hex3 = ModelFacade.facadeCurrentGame.currentgame.getMymap().getHexes().get(hexLoc3);
